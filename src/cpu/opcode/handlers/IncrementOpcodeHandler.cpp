...
class IncrementOpcodeHandler : public OpcodeHandler, public WithOperationalRegister
{
public:
    IncrementOpcodeHandler(int cycles, AddressingMode *addressingMode)
        : OpcodeHandler(cycles, addressingMode) {}

    IncrementOpcodeHandler(int cycles, Register<uint8_t> CPU::*operationalRegister)
