...
class RotateRightOpcodeHandler : public OpcodeHandler, public WithOperationalRegister
{
public:
    RotateRightOpcodeHandler(int cycles, AddressingMode *addressingMode)
        : OpcodeHandler(cycles, addressingMode) {}

    RotateRightOpcodeHandler(int cycles, Register<uint8_t> CPU::*operationalRegister)
